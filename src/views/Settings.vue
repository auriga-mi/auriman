<template>
    <div>
        ...
        <div class="grid grid-cols-1 mr-3">
            ...
            <input ref="categoryNameInput" class="py-2 px-3 rounded-md border-2 border-gray-500 mt-1 focus:outline-none focus:border-gray-800" type="text" placeholder="Application name" />
        </div>
